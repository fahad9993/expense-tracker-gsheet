...
export default function DashboardSkeleton() {
  return (
    <View>
      ...
      >
        <Rect x="25" y="10" rx="5" ry="5" width="80" height="100" />
        <Rect x="113" y="10" rx="5" ry="5" width="80" height="100" />
        <Rect x="201" y="10" rx="5" ry="5" width="80" height="100" />
        <Rect x="289" y="10" rx="5" ry="5" width="80" height="100" />
        <Rect x="109" y="130" rx="20" ry="20" width="186" height="40" />
